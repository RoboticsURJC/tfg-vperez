...
\section{Concepto}
En esta sección se expone el proceso necesario para encontrar y definir la idea fundamental del robot a desarrollar, en función de 
...
Una forma de analizar el movimiento de un sistema mecánico compuesto por ejes y eslabones es realizar el modelo alámbrico del mismo. Este 
...
\subsection{Modelo alámbrico del brazo MeArm (referencia)}

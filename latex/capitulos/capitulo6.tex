...
\section{Adaptación de grbl para su uso en robótica}

\section{Integración con ROS 2}
Con el objetivo de conseguir que el proyecto cod
...
\section{Pruebas}
En esta sección se pone a prueba la fiabilidad del brazo robot, evaluando la exactitud, fiabilidad y repetitividad, entre otras 
características.
\subsection{Exactitud}
\subsection{Fiabilidad}
\subsection{Repetitividad}
...
\hline
\end{tabular}
\caption{Evaluación del brazo robot}
\label{cuadro:evaluacion}
\end{center}
\end{table}

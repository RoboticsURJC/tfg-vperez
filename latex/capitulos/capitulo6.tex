...
\noindent TODO En esta sección se detalla el proceso de integración del robot G-Arm en \acs{ROS}, pasando 
por la creación de la descripción 
...
virtual. Esto es conocido como describir un robot. Para este propósito existen diferentes formatos que pueden 
ser utilizados entre los que destacan URDF y Xacro.
...
Para que el modelo del robot sea lo más visual y realista posible, se ha optado por utilizar las propias geometrías del diseño 3D realizadas
en el capítulo anterior. Para poder utilizarlas en URDF, es necesario exportar las piezas al formato \textit{Collada} (.dae). Este formato 

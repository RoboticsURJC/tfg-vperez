...
\noindent En esta sección se detalla el funcionamiento del nodo ROS creado para ejecutar simultáneamente las trayectorias en el robot real.
\\
...
uno nuevo para realizar las pruebas. Más adelante si es recomendable crear uno propio para poder tener mayor control sobre los nodos 
que se ejecutan y añadir nuevos.

Por otro lado, el funcionamiento del driver se ha organizado de la siguiente manera:

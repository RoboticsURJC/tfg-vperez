...
Para conseguir llevar un robot físico al mundo virtual debemos conseguir representar, de una forma realista, todos los aspectos que 
definen el robot en base a sus propiedades. Para ello se usará el siguiente formato.
\subsection{\ac{URDF}}

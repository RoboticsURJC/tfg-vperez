...
\begin{figure} [ht!]
  \centering    
  \subfigure[OSTR \footnote{\url{https://www.instructables.com/Low-Cost-Arduino-Compatible-Drawing-Robot/}}]{\label{fig:osrt}\includegraphics[width=0.4\linewidth ]{figs/OSTR.jpg}}
  \hspace{1cm}
  \subfigure[Diy-robotics 6-DOF \footnote{\url{https://diy-robotics.com/educative-robot-cell-free-package/?utm_source=Instructables.com&utm_medium=referrer&utm_campaign=Educative\%20Cell}}]{\label{fig:diyrobotics}\includegraphics[width=0.4\linewidth]{figs/diyroboticsarm.png}}

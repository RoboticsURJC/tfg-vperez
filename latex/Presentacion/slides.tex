...
\begin{frame}
  ...
  \begin{columns}
    \begin{column}{0.35\textwidth} % Columna izquierda para la imagen
      \includegraphics[width=\textwidth]{figs/test_carga.png}
    \end{column}
...
\begin{frame}
  ...
  \begin{columns}
    \begin{column}{0.35\textwidth} % Columna izquierda para la imagen
      \includegraphics[width=\textwidth]{figs/test_velocidad.png}
    \end{column}
    \begin{column}{0.5\textwidth} % Columna derecha para la tabla
...
\begin{frame}
  ...
  \begin{columns}
    \begin{column}{0.35\textwidth} % Columna izquierda para la imagen
      \includegraphics[width=\textwidth]{figs/test_consumo.png}
    \end{column}
    \begin{column}{0.5\textwidth} % Columna derecha para la tabla

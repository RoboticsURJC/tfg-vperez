...
En la Tabla \ref{cuadro:nema17_60} se muestran las especificaciones técnicas de los motores elegidos.
\begin{table}[H]
\begin{center}
\begin{tabular}{|c|c|}
\hline
...
\begin{figure} [ht!]
  \centering   
  \subfigure[Fuente de alimentación 24v 5A]{\label{fig:pw24}\includegraphics[width=0.4\linewidth ]{figs/pw24v.jpg}}
  \hspace{1cm}
  \subfigure[Cargador de portátil genérico]{\label{fig:pw19}\includegraphics[width=0.4\linewidth]{figs/pw19v.jpg}}

...
En la última orientación (Rotación en Z) se le suele incluir un cuarto grado de libertad, que en nuestro caso no tenemos. Aún así puede utilizarse con 
...
\begin{figure} [ht!]
  ...
  \end{center}
  \caption{Dimensiones de los motores Nema17}
  \label{fig:nema}
\end{figure}\ 
...
\newpage
En la Figura \ref{fig:montaje_real} se muestra el resultado real del robot. Como es obvio es idéntico al realizado en el diseño \acs{CAD} y resulta robusto 

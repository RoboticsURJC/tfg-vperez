...
La primera, es a través del propio puerto USB integrado, utilizando el protocolo serie \acs{UART}. Este modo de comunicación tiene la ventaja de 
...
\textit{UniversalGcodeSender}\footnote{\url{https://winder.github.io/ugs_website/download/}} (Figura \ref{fig:ugs}).

\begin{figure} [ht!]
\begin{center}
    \includegraphics[width=15cm]{figs/ugs.png}
\end{center}
\caption{Interfaz de UniversalGcodeSender}
\label{fig:ugs}
\end{figure}
...
\begin{figure} [ht!]
    ...
    \end{center}
    \caption{Elementos del formato URDF}
\label{fig:urdf}
\end{figure}
...
Es de tipo revolución, y su recorrido es de un radián.
...
se han llevado a cabo una serie de pruebas, bajo distintas circunstancias, y se han apuntado los resultados. Además, se ha grabado un vídeo 
para cada una de ellas: capacidad de carga\footnote{\url{https://youtu.be/McD7kLMKMo0}}, velocidad máxima\footnote{\url{https://youtu.be/37KK_hJk_tI}} y 
consumo eléctrico\footnote{\url{https://youtu.be/2MfBabEWZNo}}.
...
\begin{figure} [ht!]
    ...
    \caption{Fotos extraídas del vídeo de las pruebas de carga}
    \label{fig:loadTests}
\end{figure}\ 
...
\caption{Fotos extraídas del vídeo de las pruebas de velocidad}
...
\begin{figure} [ht!]
    ...
    \caption{Fotos extraídas del vídeo de las pruebas de consumo}
